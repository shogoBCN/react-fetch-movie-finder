...
var checkStatus = function checkStatus(response) {
  ...
  throw new Error('Request failed. Error 404 or 500. ');
};
...
var MovieFinder = function (_React$Component) {
  ...
  _createClass(MovieFinder, [{
    ...
    value: function handleSubmit(event) {
      ...
      console.log(fetch("https://www.omdbapi.com/?s=" + searchTerm + "&apikey=dbe3adf3"));
      fetch("https://www.omdbapi.com/?s=" + searchTerm + "&apikey=dbe3adf3").then(checkStatus).then(json).then(function (data) {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("input", { type: "text", className: "form-control mr-sm-2", value: searchTerm, onChange: this.handleChange }),
              React.createElement(
                "button",
